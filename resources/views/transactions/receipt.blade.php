...
<body>
    ...
    <div class="receipt-container">
        ...
        <div class="receipt-footer">
            <p class="footer-text">This is an official receipt for your transaction. Please keep it for your records.</p>
            <p class="footer-text">For any questions, contact our customer support team.</p>

            <div class="barcode">
                <img src="/api/placeholder/250/50" alt="Transaction Barcode">
            </div>
